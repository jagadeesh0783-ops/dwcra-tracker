                ...
                Object.keys(groupedMembers)
                  ...
                  <div key={groupName} style={{ marginBottom: '24px' }}>
                    ...
                    {groupedMembers[groupName].sort((a,b) => a.name.localeCompare(b.name)).map(m => {
                      ...
                      const memberTotalPaid = memberTxs.reduce((sum, tx) => sum + parseFloat(tx.amount), 0);
                ...
                return (
                  <div key={tx.id} className="list-item">
                    ...
                    <div style={{ textAlign: 'right', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '4px' }}>
                      <span className="item-amount amount-positive">+₹{parseFloat(tx.amount).toLocaleString()}</span>
